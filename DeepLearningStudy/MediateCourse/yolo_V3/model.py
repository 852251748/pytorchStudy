...
class MainNet(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        # print("test::1", h_26.shape, h_52.shape, h_13.shape)
        ...
        # print("test::2", detetion_out_13.shape, detetion_out_26.shape, detetion_out_52.shape)
...
if __name__ == '__main__':
    ...
    # x = torch.randn([2, 3,  424, 640], dtype=torch.float32)
    # 测试网络
    y_13, y_26, y_52 = trunk(x)
    print(y_13.shape)
    print(y_26.shape)
    print(y_52.shape)
    print(y_13.view(-1, 3, 8, 13, 13).shape)
